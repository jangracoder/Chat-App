...
const Login = () => {
  ...
  return (<Container component={"main"} maxWidth="xs" style={{ height:"100vh" ,display:"flex",justifyContent:"center" ,alignItems:"center"}}>
...

    {
        isLogin? (
            <>
            <Typography variant='h-5'>Login</Typography>
            <form style={{width:"100%",marginTop:"1rem"}} action="">
        ...
        <Typography variant='h-5'>Sign Up</Typography>
        <form style={{width:"100%",marginTop:"1rem"}} action="">
